...
export default function NewProductPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const priceToSend = parseFloat(form.price.replace(/[^\d.,]/g, "").replace(",", "."));
      ...
      >
        ...
        <div>
          <input
            name="price"
            type="text"
            placeholder="Preço (ex: 12.34)" // Altere o placeholder para indicar o formato esperado
            className={`border px-3 py-2 rounded-xl w-full ${errors.price ? "border-red-500" : ""}`}
            value={form.price}
            onChange={handlePriceInputChange} // Durante a digitação, use esta função
            onBlur={handlePriceBlur} // Ao perder o foco, use esta função para formatar
            disabled={loading}
          />
